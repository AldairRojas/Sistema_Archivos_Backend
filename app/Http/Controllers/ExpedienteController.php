...
class ExpedienteController extends Controller
{
    ...
    return [
        ...
        'fecha_ingreso'       => $expediente->fecha_ingreso?->format('Y-m-d'),
        'tiempo_conservacion' => $expediente->tiempo_conservacion,
        'fecha_revision'      => $expediente->fecha_revision?->format('Y-m-d'),
    ...
    public function store(Request $request)
    {
        ...
        // ── Calcular fecha_revision desde tiempo_conservacion ──
    ...
    {
        $tipos = TipoDocumento::select('id', 'nombre')
            ->orderBy('nombre')
            ->get();
